        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-surface-container-lowest border border-zinc-800 p-5 relative overflow-hidden machined-edge">
              ...
              <p className="font-label text-[10px] uppercase tracking-widest text-zinc-500 mb-2">Total_de_Usuários</p>
            ...
            <div className="bg-surface-container-lowest border border-zinc-800 p-5 relative overflow-hidden machined-edge">
              ...
              <p className="font-label text-[10px] uppercase tracking-widest text-zinc-500 mb-2">Arquivos_de_Áudio</p>
            ...
            <div className="bg-surface-container-lowest border border-zinc-800 p-5 relative overflow-hidden machined-edge">
              ...
              <p className="font-label text-[10px] uppercase tracking-widest text-zinc-500 mb-2">Total_de_Reproduções</p>
