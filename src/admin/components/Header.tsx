  ...
  return (
    <header className="fixed top-0 w-full z-50 flex justify-between items-center px-6 h-14 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-800 shadow-[0_0_15px_rgba(255,140,0,0.1)]">
      <div className="flex items-center gap-4">
        ...
        <span className="font-label uppercase tracking-widest text-[10px] text-orange-500 animate-pulse">OPERATIONAL_STATUS: ACTIVE</span>
      </div>
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 ml-4">
          <div className="text-right hidden sm:block">
            <p className="text-[10px] font-label uppercase tracking-tighter text-zinc-400">Operator_ID</p>
