...
import { loadPlayerData, firestoreUnlockTape, firestoreGrantAchievements } from './store/firestore';
...
const SideControls = ({ volume, setVolume, onModeChange, onProfileOpen }: {
  ...
  <div className="absolute right-2 top-[240px] bottom-20 flex flex-col items-center justify-center gap-6 w-16">
    ...
    <motion.div drag="y" dragConstraints={{ top: -20, bottom: 20 }} dragElastic={0.1}
      ...
      <div className="absolute -top-4 text-gray-500 group-hover:text-orange-500 pointer-events-none"><div className="w-0 h-0 border-l-[4px] border-l-transparent border-r-[4px] border-r-transparent border-b-[6px] border-b-current" /></div>
      <div className="absolute -bottom-4 text-gray-500 group-hover:text-orange-500 pointer-events-none"><div className="w-0 h-0 border-l-[4px] border-l-transparent border-r-[4px] border-r-transparent border-t-[6px] border-t-current" /></div>
    </motion.div>
    <div className="w-8 flex-1 max-h-40 bg-[#1a1a1a] rounded-full border-2 border-[#333] relative flex flex-col items-center py-2 shrink-0">
      ...
      <div className="flex-1 w-1 bg-[#222] rounded-full relative overflow-visible">
        ...
        <motion.div className="absolute left-1/2 -translate-x-1/2 w-6 h-8 bg-gradient-to-b from-stone-200 to-stone-400 rounded border-2 border-stone-600 shadow-lg cursor-ns-resize flex flex-col justify-center items-center gap-0.5 z-10"
