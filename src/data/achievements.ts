...
// We map all old and new achievements into the OOP Engine
// Since the user requested all achievements to be secret and without descriptions on how to obtain them,
// We hide hinting strings "???"
...
const registerAchievements = () => {
  ...
  // Example of an Admin-only manual given achievement
...
// Keep ALL_ACHIEVEMENTS export for UI compatibility temporarily
